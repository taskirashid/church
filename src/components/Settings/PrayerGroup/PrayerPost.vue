            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content" >
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Add Prayer Group</h4>
                </div>
  ...
  methods: {
    ...
    async submitForm() {
      try {
        ...
        const response = await axios.post('/prayer-group/add-prayer-group', {prayerGroupName: this.message});
        console.log(response.data);
        this.prayerGroupName=response.data.listOfPrayerGroup
        this.$emit('getPrayerGroupList')
